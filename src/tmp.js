        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, litNodeClient.executeJs({
                        ...
                        jsParams: {
                            dataToSign: ethers_1.ethers.utils.arrayify(ethers_1.ethers.utils.keccak256([1, 2, 3, 4, 5, 6])),
            ...
            case 4:
                ...
                crypto_1.verifySignature(pkp.publicKey, uint8arrays_1.uint8arrayFromString(executeJsRes.signatures.sig.dataSigned), uint8arrays_1.uint8arrayFromString(executeJsRes.signatures.sig.signature));
                return [2 /*return*/];
        }
    });
}); })();
